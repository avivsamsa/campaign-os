...
import { ActivityIndicator, I18nManager, RefreshControl, ScrollView, StyleSheet, Text, View } from 'react-native';
...
// תוכן הדשבורד בלבד (בלי כותרת/החלקה) — משמש כדף האמצעי ב-pager.
